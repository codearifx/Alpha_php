...
if(isset($savedata))
{
  ...
  header('Refresh: 0; URL=payment.php?eid='.$eid.'&name='.$name.'&email='.$email.'&phone='.$phone.'&address='.$address.'&city='.$city.'&state='.$state.'&zip='.$zip.'&country='.$country.'&room_type='.$room_type.'&cdate='.$cdate.'&ctime='.$ctime.'&codate='.$codate.'&occupancy='.$Occupancy.'');
